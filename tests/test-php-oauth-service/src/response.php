...
class ReponseController
{
  ...
  public function verify_access_token($encrypted_authorization_token)
  {
    ...
    {
      throw new \Exception("Access token doesn't contain expected structure.");
    }
    ...
    {
      throw new \Exception("Access token isn't of the type string.");
    }
