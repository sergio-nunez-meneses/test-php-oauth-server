...
Finally, create a private/public key pair to sign, encrypt, decrypt and validate tokens. Change directory to the folder ```test``` and paste the following line in the terminal:
